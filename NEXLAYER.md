...
**Live:** [https://relaxed-weasel-weaviate.cloud.nexlayer.ai](https://relaxed-weasel-weaviate.cloud.nexlayer.ai)  
...
**weaviate** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/semitechnologies/weaviate:latest
    path: /
    servicePorts:
    - 8080
    vars:
